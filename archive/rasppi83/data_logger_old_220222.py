...
def main():
    """ Main function """
    ports = dict()
    ports['Sample'] = '/dev/serial/by-id/usb-FTDI_USB-RS485_Cable_AU064FF5-if00-port0'
    ...
    sample_logger = TcReader(ports['Sample'], datasocket, crit_logger=logger, db_logger=db_logger, codename=CODENAMES['Sample'], logger=logger2)
    sample_logger.start()
